...
public class FileUploadController extends BaseAjaxController {
	...
	public static final String SuccessPage="common/javascriptPage";
...
//		String uploadedPicture=HttpUtil.getString(request, "uploadedPicture", "");
//		String filenames=HttpUtil.getString(request, "filename", "");
		...
		try{
			...
			if(file!=null&&file.getSize()>0){
				...
				if(typeMap.get(entity.getFileType()).indexOf(filename.substring(filename.lastIndexOf(".")+1).toLowerCase())==-1){//判断类型
